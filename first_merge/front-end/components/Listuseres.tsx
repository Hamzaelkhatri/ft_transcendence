...
const ListUseres = (props) => {
  const hundelClick1 = async (e, id) => {
    e.preventDefault();
    axios.post(`http://backdend:3001/requests/users/me/friends/${id}`, {
        headers: {
  ...
  const hundelClick2 = async (e, req_id) => {
    e.preventDefault();
    axios.delete(`http://backdend:3001/requests/${req_id}`, {
        headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
          },
    });
  ...
  const hundelClick3 = async (e, req_id,id) => {
    e.preventDefault();
    axios.post(`http://backdend:3001/requests/${req_id}/users/me/friends/${id}/accept`, {
        headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
          },
    });
