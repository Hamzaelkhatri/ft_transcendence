...
const Next_page = () => {
    ...
    const close = (key: string) => {
        axios.get("http://10.12.5.9:3000/game/invited/reject/" + localStorage.getItem("id") + "/" + context.ShowCanvas.gameInfo['id']).then(res => {
    ...
    const onclick = (key: string) => {
        ...
        axios.get("http://10.12.5.9:3000/game/invited/confirm/" + localStorage.getItem("id") + '/' + context.ShowCanvas.gameInfo['id']).then(res => {
    ...
    useEffect(() => 
    {
        const inter = setInterval(() => {
            if (oneTime1 == 0) {
                ...
                axios.get("http://10.12.5.9:3000/game/is_invited/" + localStorage.getItem("id"))
                    .then(res => {
    ...
    axios.get("http://10.12.5.9:3000/user/random")
        .then(res => {
            if (oneTime === 0) {
                setData(res.data);
                setOneTime(1);
                ...
                {!context.ShowCanvas.show &&
                    <Card
                        ...
                        <PlayCircleOutlined key="play" onClick={() => {
                            axios.post("http://10.12.5.9:3000/game/invite",
                            {
