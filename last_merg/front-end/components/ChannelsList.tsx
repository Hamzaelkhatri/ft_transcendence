...
const ChannlesList = (props) => {
  ...
  const hundelsubmitprivate = async (e) => {
    ...
    axios
      .post(
        "http://192.168.99.103:3001/channels/create/private/users/me",
        {
          name: selectedname,
  ...
  const hundelsubmitprivatejoin = async (e, id) => {
    ...
    axios
      .post(
        `http://192.168.99.103:3001/channels/join/${id}/private/users/me`,
        {
  ...
  const hundelsubmitpublic = async (e) => {
    ...
    axios
      .post(
        "http://192.168.99.103:3001/channels/create/public/users/me",
        {
          name: selectedname,
        },
        {
  ...
  const hundelsubmitpublicjoin = async (e, id) => {
    ...
    axios
      .post(
        `http://192.168.99.103:3001/channels/join/${id}/public/users/me`,
        {},
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
