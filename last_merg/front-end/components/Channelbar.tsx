...
const ChannelBar = (props) => {
  ...
  const hundelkickuser = async (e) => {
    e.preventDefault();
    axios.delete(
      `http://192.168.63.100:3001/channels/kick/${props.mychannel.id}/users/${userid}`,
      {
        headers: {
  ...
  const hundelsetasadmin = async (e) => {
    e.preventDefault();
    axios.put(
      `http://192.168.63.100:3001/channels/admin/${props.mychannel.id}/users/${userid}`,
      {},
      {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const hundelfireadmin = async (e) => {
    e.preventDefault();
    axios.put(
      ` http://192.168.63.100:3001/channels/user/${props.mychannel.id}/users/${userid}`,
      {},
      {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const hundelsubmittime = async (e) => {
    ...
    axios
      .put(
        `http://192.168.63.100:3001/channels/ban/${props.mychannel.id}/users/${userid}`,
        {
          time: selectedtime,
        },
        {
  ...
  const hundelsubmittimemute = async (e) => {
    ...
    axios
      .put(
        `http://192.168.63.100:3001/channels/mute/${props.mychannel.id}/users/${userid}`,
        {
          time: selectedtime,
        },
        {
